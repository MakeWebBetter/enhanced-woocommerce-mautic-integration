				...
				<div class="mauwoo-static-menu">
					<ul>
						...
						<li class="mauwoo-main-menu-button"><a id="mauwoo-go-mautic-email-templates-link"
								...
								class="" title=""
								target="_blank"><?php esc_html_e( 'Mautic Email Templates', 'mautic-woo' ); ?></a></li>
						<li class="mauwoo-main-menu-button"><a id="mauwoo-skype-link"
								...
								title="" target="_blank"><i
									class="fab fa-skype"></i><?php esc_html_e( 'Chat Now', 'mautic-woo' ); ?></a></li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="mauwoo-header-cron-notice">
			<div class="updated">
				<p>
					...
					$txt = sprintf( __( 'Next Mautic Woocommerce sync :  %1$s at %2$s ', 'mautic-woo' ), $date, $time );
					echo esc_html( $txt );
					?>
				</p>
			</div>
		...
		<div class="mauwoo_pop_up_wrap" style="display:none">
			<div class="pop_up_sub_wrap">
				<p class="updated">
					...
					<p>
						<?php esc_html_e( 'You can sync all your previous customers and orders data over mautic by using "One Click Sync" feature of our pro plugin. Please upgrade to pro.', 'mautic-woo' ); ?>
					</p>
					<p>
						<a href="<?php echo esc_url( MAUTIC_WOO_PRO_LINK ); ?>" class="mauwoo-button" target="_blank"
							style="margin-top: 35px;"><?php esc_html_e( 'Upgrade now', 'mautic-woo' ); ?></a>
					</p>
				</p>
