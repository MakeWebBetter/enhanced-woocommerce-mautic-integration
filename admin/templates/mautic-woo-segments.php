...
<div class="mauwoo-fields-header mauwoo-common-header text-center">
	<h2><?php esc_html_e( 'Segment your woocommerce users', 'mautic-woo' ); ?></h2>
...
<p class="mauwoo_go_pro text-center"><?php esc_html_e( 'Create Contact Segments in mautic on the basis of your WooCommerce store data.', 'mautic-woo' ); ?>
</p>
