...
<div class="mauwoo-fields-header mauwoo-common-header text-center">
	<h2><?php esc_html_e( 'Activity Sync', 'mautic-woo' ); ?></h2>
...
<p class="mauwoo_go_pro text-center"><?php esc_html_e( 'Add tags to your mautic contacts based on their user activity and order activity', 'mautic-woo' ); ?>
</p>
