...
<h2><?php esc_html_e( 'Target your customers using RFM settings', 'mautic-woo' ); ?></h2>
...
<?php esc_html_e( 'Create different types of customer segments with RFM analysis, Instead of reaching out to 100% of your audience, you need to identify and target only specific customer groups that will turn out to be most profitable for your business.', 'mautic-woo' ); ?>
</p>
